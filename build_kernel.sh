#!/bin/sh
# Build Script: Jdizzle80, 09-03-2015
# kernowtrader@icloud.com
#
...
export TOOLBASE="/home/parallels/android/Kernel/buildtools"
...
TOOLCHAIN="/home/parallels/android/toolchains/arm-eabi-4.7/bin/arm-eabi-"
TOOLCHAIN_PATCH="/home/parallels/android/toolchains/arm-eabi-4.7/bin"
ROOTFS_PATH="/home/parallels/android/Kernel/ramdisk"
RAMFS_TMP="/home/parallels/android/tmp/ramfs-source-sgs5"

export KERNEL_VERSION="JDK-0.11"
...
cp arch/arm/configs/apq8084_sec_defconfig .config
...
echo "#################### Make defconfig ####################"
#v.1make VARIANT_DEFCONFIG=apq8084_sec_kccat6_eur_defconfig apq8084_sec_defconfig SELINUX_DEFCONFIG=selinux_defconfig
...
#make VARIANT_DEFCONFIG=apq8084_sec_kccat6_eur_defconfig apq8084_sec_defconfig SELINUX_DEFCONFIG=selinux_defconfig SELINUX_LOG_DEFCONFIG=selinux_log_defconfig TIMA_DEFCONFIG=tima_defconfig DMVERITY_DEFCONFIG=dmverity_defconfig
...
#fi
find . -name '*.ko' -exec cp -av {} /home/parallels/android/jdko/ \;
...
rm -rf /home/parallels/android/tmp/ramfs-source-sgs5 > /dev/null 2>&1
rm /home/parallels/android/tmp/ramfs-source-sgs5.cpio.gz > /dev/null 2>&1
echo "#################### Finished  ####################"
